namespace 企业管理.PerForm
{
    partial class F_Find
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_Find));
			...
			this.label8.Location = new System.Drawing.Point(432, 104);
			...
			this.Find_Kultur.SelectedIndexChanged += new System.EventHandler(this.Find_Kultur_SelectedIndexChanged);
			// 
			// Find_Business
			// 
			...
			this.Find_BeAware.SelectedIndexChanged += new System.EventHandler(this.Find_BeAware_SelectedIndexChanged);
