namespace 企业管理.PerForm
{
    partial class F_ClearData
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_ClearData));
			...
			this.Table_RANDP.Location = new System.Drawing.Point(138, 117);
			...
			this.Table_RANDP.CheckedChanged += new System.EventHandler(this.Table_RANDP_CheckedChanged);
			...
			this.Table_Individual.Location = new System.Drawing.Point(138, 139);
			...
			this.Table_WordResume.Text = "加班出差";
			...
			this.Table_TrainNote.Location = new System.Drawing.Point(138, 95);
			...
			this.Table_TrainNote.CheckedChanged += new System.EventHandler(this.Table_TrainNote_CheckedChanged);
			...
			this.Table_DayWordPad.Size = new System.Drawing.Size(74, 19);
			this.Table_DayWordPad.TabIndex = 14;
			this.Table_DayWordPad.Text = "日志本";
			...
			this.ALL_Table.Location = new System.Drawing.Point(26, 184);
			...
			// but_clear
			// 
			this.but_clear.Location = new System.Drawing.Point(169, 181);
			...
			// but_Close
			// 
			this.but_Close.Location = new System.Drawing.Point(271, 181);
