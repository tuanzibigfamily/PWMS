namespace 企业管理.InfoAddForm
{
    partial class F_Address
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(F_Address));
			...
			this.Address_4.TextChanged += new System.EventHandler(this.Address_4_TextChanged);
			// 
			// label3
			// 
			...
			this.Address_1.TextChanged += new System.EventHandler(this.Address_1_TextChanged);
			// 
			// groupBox2
			// 
